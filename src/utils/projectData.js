...
export const allProjects = [
  {
    ...
    title: "React Timer",
    description:
      "React Hooks의 특성을 깊이 있게 활용하여 개발한 웹 기반 타이머 애플리케이션으로, 초 단위 시간 데이터를 안정적으로 다룬 프로젝트 입니다.",
  ...
  },
  {
    ...
    title: "Router Exam",
    description:
      "React Router DOM의 동적 라우팅을 활용하여 커뮤니티 게시판과 전역 상태 기반의 Todo 앱 등 여러 독립적인 기능을 하나의 SPA(Single Page Application)로 성공적으로 통합한 프로젝트입니다.",
  ...
  },
  {
    ...
    description:
      "Axios를 통한 OpenWeather API 비동기 통신으로 실시간 기상 데이터를 연동하고, 환경 변수(.env)를 활용한 API Key 보안과 날씨에 따른 동적 UI 렌더링을 구현한 프로젝트입니다.",
  ...
  },
  {
    ...
    description:
      "사용자의 일정을 관리할 수 있는 웹 애플리케이션으로, 상태 관리의 효율성과 코드의 유지보수성을 높이는 데 집중한 리팩토링 프로젝트입니다.",
  ...
  },
  {
    ...
    title: "Emotion Diary",
    description:
      "Context API와 useReducer를 결합하여 전역 상태 관리를 구현하고, LocalStorage를 활용한 비휘발성 데이터 보존 및 동적 라우팅 방어 로직을 적용한 다이어리 웹 애플리케이션입니다.",
    tags: ["React 19", "Context API", "useReducer", "LocalStorage"],
    type: "web",
  ...
  },
  {
    ...
    title: "Cooling Spot",
    description:
      "Kakao Maps API를 비동기적으로 로드하여 다중 마커를 렌더링하고, Context API 및 LocalStorage를 활용해 즐겨찾기 상태를 전역으로 관리하는 지도 기반 웹 애플리케이션입니다.",
  ...
  },
  {
    ...
    title: "Kia selling",
    description:
      "데이터 모듈화를 통해 컴포넌트 재사용성을 높이고, SCSS와 Swiper.js를 활용하여 다이내믹한 슬라이드 애니메이션과 기기별 해상도 대응(반응형)을 구현한 웹사이트 리디자인 프로젝트입니다.",
  ...
  },
  {
    ...
    title: "Save Point",
    description:
      "Spring Boot와 AWS S3를 활용하여 RESTful API 및 이미지 저장을 구현하고, Kakao OAuth 2.0 기반 인증과 Docker 컨테이너 및 커스텀 도메인 연동 배포까지 구축한 풀스택 프로젝트입니다.",
  ...
  },
  {
    ...
    title: "Portfolio V1",
    description:
      "지금 보고 계신 이 포트폴리오 웹사이트입니다. 반응형 디자인과 재사용 가능한 컴포넌트 구조로 설계한 웹 어플리케이션 입니다.",
    tags: ["React 19", "SCSS", "Three.js"],
    type: "web",
    demoLink:
      "https://app.notion.com/p/Portfolio-3565b18cdc30809b8819de9c16a481d5",
  ...
  },
  {
    ...
    title: "쇼핑 위시리스트 콜렉터",
    description:
      "파이썬 백엔드(FastAPI)와 네이버 쇼핑 API를 연동하여, 관심 상품을 실시간으로 검색하고 클라우드 DB(MongoDB)에 즐겨찾기로 관리할 수 있는 풀스택 웹 애플리케이션입니다.",
  ...
  },
  {
    ...
    title: "ForexMonitor",
    description:
      "실시간 환율 API 연동 및 LocalStorage 기반 상태 관리를 활용하여 외화 자산 매수/매도 시 기초자금 차감 로직을 구현한 외환 자산 모니터링 애플리케이션입니다.",
  ...
  },
  {
    ...
    description:
      "Unity 6 엔진과 C#을 기반으로 2D 탑다운 서바이벌 게임을 개발하고, Vercel을 통한 WebGL 자동 배포 파이프라인(CI/CD)을 구축한 프로젝트입니다.",
  ...
  },
  {
    ...
    title: "Nexus Hub",
    description:
      "물류 도메인의 B2C, B2B 타겟을 분리해 기획하고, AuthContext와 커스텀 훅(useRequireAuth)을 활용한 프라이빗 라우팅 제어 및 SCSS 기반의 반응형 UI를 완벽하게 구현한 프론트엔드 팀 리딩 프로젝트입니다.",
    tags: ["React 18", "TypeScript", "React Router", "SCSS", "Vercel"],
    type: "web",
    demoLink: "https://team-project-nexus-hub.vercel.app/",
    codeLink:
      "https://github.com/seokhyeon09/TeamProject-Responsive_Logistics_System_Project",
    imageSrc: "/assets/images/nexushub.png",
    fallbackIcon: "laptop",
    deviceType: "desktop",
  },
];
...
export const FEATURED_PROJECT_IDS = [7, 8, 13];
